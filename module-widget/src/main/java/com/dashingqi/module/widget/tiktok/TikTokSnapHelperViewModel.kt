...
class TikTokSnapHelperViewModel(application: Application) : BasePageViewModel<String>(application) {
    ...
    override fun requestData(page: Int) {
        items.add("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1598511988840&di=639725388059d4c8e67624a06e1bd685&imgtype=0&src=http%3A%2F%2Fa4.att.hudong.com%2F52%2F52%2F01200000169026136208529565374.jpg")
