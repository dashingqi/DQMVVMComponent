 ...
 * desc :
 */
class WidgetOpenEyeSpecialSquareCarCollectionViewModel(application: Application) : BasePageViewModel<OpenEyeResponse.DataItemListDataBean>(application) {
    ...
    override fun getItemLayoutId(): Int {
        return R.layout.widget_open_eye_item_special_card_collection_sun
    }
}